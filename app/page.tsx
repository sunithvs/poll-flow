        ...
        <main className="flex-1 flex flex-col gap-6 px-4 pb-12">
            <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                >
                    ...
                    <p className="text-muted-foreground">Watch votes come in instantly with our real-time polling
                        system</p>
                </motion.div>
                ...
                >
                    ...
                    <p className="text-muted-foreground">Share your polls with a simple link and get instant
                        feedback</p>
                </motion.div>
            </div>
